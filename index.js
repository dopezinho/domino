  ...
  // plusClick5.addEventListener("click", () => {
  //   totalClick1(5)   
  // });

  // plusClick10.addEventListener("click", () => {
  //   totalClick1(10)   
  // });

  // plusClick20.addEventListener("click", () => {
  //   totalClick1(20)   
  // });
  ...
  function showPoints() {
    ...
    if (totalPoints1 % 50 === 0){
      circles[circles.length - totalPoints1/50].classList.add('ticked');
    }
      // if (totalPoints1 === 200) {
...
// const x = document.querySelectorAll('.cls-10')
// console.log(x);
